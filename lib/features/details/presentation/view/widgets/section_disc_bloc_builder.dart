...
import 'package:slash_task/features/details/presentation/view/widgets/bloc_consumer_discription.dart';
import 'package:slash_task/features/details/presentation/view_model/get_product_cubit/get_product_cubit.dart';

class SectionDiscBlocBuilder extends StatelessWidget {
  const SectionDiscBlocBuilder({super.key});
    ...
    return BlocBuilder<GetProductCubit, GetProductState>(
      builder: (context, state) {
        if (state is GetProductLoaded) {
          ...
          return DiscriptionBlocConsumer(
